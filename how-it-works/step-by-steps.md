...
<figure><img src="../.gitbook/assets/step-1-deposit.svg" alt="Step 1 — User wallet deposits assets to the Token Gateway (Starknet or Ethereum) and receives fyToken shares (ERC-4626, directional in underlying)."><figcaption><p>User → Token Gateway → fyToken.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/step-2-netting.svg" alt="Step 2 — Per-chain deposits and withdrawals are batched at the rollup level, then a single net delta is broadcast to the Controller on Starknet."><figcaption><p>Hundreds of user-level flows → one cross-chain net delta.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/step-3-vault-settlement.svg" alt="Step 3 — The net delta from the Controller flows through Ethereum&#x27;s canonical bridge into the main Vault (Veda BoringVault on Ethereum)."><figcaption><p>Only the final net result is bridged. All yield activity Ethereum-secured.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/step-6-earn.svg" alt="Step 6 — Auto-compounding visualization: fyToken share price grows over time while the token count stays constant."><figcaption><p>Auto-compounded. Your token count never changes — each token grows in value.</p></figcaption></figure>
