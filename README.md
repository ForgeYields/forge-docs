...
<figure><img src=".gitbook/assets/positioning-frontier.svg" alt="ForgeYields positioning in the DeFi yield landscape — Y-axis: yield ceiling. X-axis: no wrapper vs wrapper vault. Existing wrappers (Morpho-Steakhouse, Morpho-Gauntlet, Yearn V3) cluster below the wrapper-side yield ceiling. ForgeYields is the only wrapper above the ceiling, methodology-gated by Hallmark."><figcaption><p>Where ForgeYields sits in the landscape. Same wrapper-level discipline as Yearn / Morpho-curated, but Hallmark's published methodology lets us safely include the frontier strategies the others won't.</p></figcaption></figure>
